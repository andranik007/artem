...
--
-- Хост: 127.0.0.1
-- Время создания: Мар 05 2024 г., 09:08
...
INSERT INTO `users` (`id`, `login`, `password`, `salt`, `birthdate`, `email`, `country`, `fio`, `status_id`, `role`, `registration_date`, `is_admin`) VALUES
(2, 'User123', '6c18744cb124c654233f08ae9855c827', '$Apt_%3Ov~\"Pg]^1J8.?S_zE?u;LR-3oCEz\"Z}Cf,3-pxg^O)Fsv]LnA<5RhhXqn=94(Qi(Vj6&Wh&~<)Re/;T19n$`a}llO9fQ', '2004-12-22', 'asd@asdadsфы', 'Россия', 'Семернин Артем Витальевич', 2, 'admin', '2024-02-21 12:51:35', 0),
(6, 'Admin123', '$2y$10$9l6ADG5MkQLh96fQizyJUexOVi56qmVyaTPH1IiJcM1HXgmuxLke2', '', '2004-12-22', 'Admin123@mail.ru', 'Россия', 'Семернин Артем Витальевич', 1, 'user', '2024-02-21 13:14:25', 0),
(8, 'Admin1523', '$2y$10$sVFTOTGfDxQC74FLZJkywO4D9HMlPi/w3rZFJHmHL7SqZghznKwUC', '', '2004-12-22', 'so.zatvordfgnik.lo@gmail.com', 'Россия', 'Семернин Артем Витальевич', 1, 'admin', '2024-02-22 08:13:53', 1),
(9, 'обычный юзер', '$2y$10$K/.hmHZXm88KSSk.biTVuOklV5QM2bKl9XnSRCc8.13sJ9WBoIL2m', '', '2004-12-22', 'so.zatfdvornik.lo@gmail.com', 'Россия', 'Семернин Артем Витальевич', 1, 'user', '2024-02-22 10:48:56', 0),
(10, 'Se7En', '$2y$10$NmScDEfCDFCrPQmT30iFn.BMtYSoyccJn3KPdVqkC2nW/PBj63KSe', '', '2004-12-22', 'Se7Enagd@asdads', 'Россия', 'Семернин Артем Витальевич', 1, 'admin', '2024-02-26 14:01:50', 0),
(11, 'inferno', '$2y$10$7BEbTf4nCfQgxcP4IH/T8OMdabwT3ZCypRdG2iDhCedhTyPhCiNYG', '', '2004-12-22', 'Semernin02@gmail.com', 'Россия', 'Артем Семернин Витальевич', 1, 'user', '2024-03-04 11:07:49', 0);
